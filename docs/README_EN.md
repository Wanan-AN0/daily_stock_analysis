...
| `AGENT_SKILLS` | Comma-separated active strategy-skill ids. Leave empty to use the default-active set declared in skill metadata; use `all` to activate every loaded strategy skill. | Optional |
